...
$max_placeholder = isset($data['max_placeholder']) ? $data['max_placeholder'] : '';

$default_value = isset($data['default_value']) ? $data['default_value'] : '';
$max_default_value = isset($data['max_default_value']) ? $data['max_default_value'] : '';

$radius = isset($data['radius']) ? $data['radius'] : 5000;
$hide_empty = isset($data['hide_empty']) ? $data['hide_empty'] : 1;
$display_all_terms = isset($data['all_terms']) ? $data['all_terms'] : 1;
$terms = (isset($data['terms']) and is_array($data['terms'])) ? $data['terms'] : array();

$min = isset($data['min']) ? $data['min'] : 0;
$max = isset($data['max']) ? $data['max'] : 100;
$increment = isset($data['increment']) ? $data['increment'] : 10;
$th_separator = isset($data['th_separator']) ? $data['th_separator'] : 1;
?>
    ...
    <div class="lsd-row">
        <div class="lsd-col-12">
            ...
            <div class="lsd-search-field-param lsd-search-method-dependant lsd-search-method-dropdown-plus">
                ...
                <select class="widefat" name="lsd[fields][<?php echo esc_attr($i); ?>][filters][<?php echo esc_attr($key); ?>][th_separator]" title="<?php esc_attr_e('Thousands Separator', 'listdom'); ?>">
            ...
            <div class="lsd-search-method-dependant lsd-search-method-dropdown lsd-search-method-dropdown-multiple lsd-search-method-hierarchical lsd-search-method-checkboxes lsd-search-method-radio">
                ...
                <div class="lsd-search-field-param lsd-search-field-terms <?php echo ($display_all_terms == 1 ? 'lsd-util-hide' : ''); ?>">
                    ...
                    <ul>
                        <?php echo $helper->tax_checkboxes(array(
                            'taxonomy' => $key,
