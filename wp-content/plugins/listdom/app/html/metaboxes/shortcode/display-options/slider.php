...
$slider = isset($options['slider']) ? $options['slider'] : array();
?>
...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-10">
        <p class="description"><?php echo sprintf(esc_html__('Using %s skin, you can show a slider of istings with different styles.', 'listdom'), '<strong>'.esc_html__('Slider', 'listdom').'</strong>'); ?></p>
    </div>
</div>
<div class="lsd-form-row">
    ...
    <div class="lsd-col-6">
        <?php echo LSD_Form::select(array(
            ...
            'value' => (isset($slider['style']) ? $slider['style'] : 'style1')
        )); ?>
    </div>
</div>
<div class="lsd-form-row">
    ...
    <div class="lsd-col-6">
        <?php echo LSD_Form::text(array(
            ...
            'value' => (isset($slider['limit']) ? $slider['limit'] : '6')
        )); ?>
    </div>
</div>
...
<div class="lsd-form-row">
    ...
    <div class="lsd-col-6">
        <?php echo LSD_Form::select(array(
            ...
            'value' => (isset($slider['listing_link']) ? $slider['listing_link'] : 'normal'),
            'options' => array(
