    ...
    <ul>
        <li>
            ...
            <select name="lsd[mapcontrols][zoom]" id="lsd_map_control_zoom">
                ...
                <option value="<?php echo esc_attr($position); ?>" <?php echo ((isset($mapcontrols['zoom']) and $mapcontrols['zoom'] == $position) ? 'selected="selected"' : ''); ?>><?php echo esc_html($label); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <li>
            ...
            <select name="lsd[mapcontrols][maptype]" id="lsd_map_control_maptype">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <?php foreach($positions as $position=>$label): ?>
                    <option value="<?php echo esc_attr($position); ?>" <?php echo ((isset($mapcontrols['maptype']) and $mapcontrols['maptype'] == $position) ? 'selected="selected"' : ''); ?>><?php echo esc_html($label); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <li>
            ...
            <select name="lsd[mapcontrols][streetview]" id="lsd_map_control_streetview">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <?php foreach($positions as $position=>$label): ?>
                    <option value="<?php echo esc_attr($position); ?>" <?php echo ((isset($mapcontrols['streetview']) and $mapcontrols['streetview'] == $position) ? 'selected="selected"' : ''); ?>><?php echo esc_html($label); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <li>
            ...
            <select name="lsd[mapcontrols][draw]" id="lsd_map_control_draw">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <?php foreach($positions as $position=>$label): ?>
                    <option value="<?php echo esc_attr($position); ?>" <?php echo ((isset($mapcontrols['draw']) and $mapcontrols['draw'] == $position) ? 'selected="selected"' : ''); ?>><?php echo esc_html($label); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <li>
            ...
            <select name="lsd[mapcontrols][gps]" id="lsd_map_control_gps">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <?php foreach($positions as $position=>$label): ?>
                    <option value="<?php echo esc_attr($position); ?>" <?php echo ((isset($mapcontrols['gps']) and $mapcontrols['gps'] == $position) ? 'selected="selected"' : ''); ?>><?php echo esc_html($label); ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <li>
            ...
            <select name="lsd[mapcontrols][scale]" id="lsd_map_control_scale">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <option value="1" <?php echo ((isset($mapcontrols['scale']) and $mapcontrols['scale'] == 1) ? 'selected="selected"' : ''); ?>><?php esc_html_e('Enabled', 'listdom'); ?></option>
            </select>
            <p class="description"><?php esc_html_e('Displays a map scale element in bottom of map. This control is disabled by default.', 'listdom'); ?></p>
        </li>
        <li>
            ...
            <select name="lsd[mapcontrols][fullscreen]" id="lsd_map_control_fullscreen">
                <option value="0"><?php esc_html_e('Disabled', 'listdom'); ?></option>
                <option value="1" <?php echo ((isset($mapcontrols['fullscreen']) and $mapcontrols['fullscreen'] == 1) ? 'selected="selected"' : ''); ?>><?php esc_html_e('Enabled', 'listdom'); ?></option>
            </select>
            <p class="description"><?php esc_html_e('Offers the option to open the map in fullscreen mode. This control is enabled by default on mobile devices, and is disabled by default on desktop.', 'listdom'); ?></p>
        </li>
    </ul>
</div>