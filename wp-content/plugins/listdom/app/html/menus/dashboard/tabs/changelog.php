...
<div class="lsd-changelog-wrap">
    ...
    <ul class="lsd-changelog">
        ...
        <li>
            <span class="lsd-changelog-added"><?php esc_html_e('Added an option to load listing details page into light-box on click of marker.', 'listdom'); ?></span>
        </li>
        <li>
    ...
    <h2>v1.5.0 <span>Fabruary 8th, 2020</span></h2>
    <ul class="lsd-changelog">
        <li>
    ...
    <ul class="lsd-changelog">
        ...
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit.php?post_type='.LSD_Base::PTYPE_NOTIFICATION)); ?>"><?php esc_html_e('Added an dashboard notification system to manage the system emails.', 'listdom'); ?></a></span>
        </li>
        <li>
            <span class="lsd-changelog-added"><?php esc_html_e('Added HTML marker to leaflet.', 'listdom'); ?></span>
        </li>
        <li>
            <span class="lsd-changelog-updated"><?php esc_html_e('Improved leaflet clustering for polygon, rectangle and polylines.', 'listdom'); ?></span>
        </li>
        <li>
    ...
    <ul class="lsd-changelog">
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit.php?post_type='.LSD_Base::PTYPE_SEARCH)); ?>"><?php esc_html_e('Added Advanced Search Builder', 'listdom'); ?></a></span>
            <ul class="lsd-sub-changelog">
    ...
    <ul class="lsd-changelog">
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit.php?post_type='.LSD_Base::PTYPE_SHORTCODE)); ?>"><?php esc_html_e('Added Shortcode Generator', 'listdom'); ?></a></span>
            <ul class="lsd-sub-changelog">
        ...
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_CATEGORY.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Listing Category', 'listdom'); ?></a></span>
            <ul class="lsd-sub-changelog">
        ...
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_LOCATION.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Hierarchical Listing Location', 'listdom'); ?></a></span>
            <ul class="lsd-sub-changelog">
        ...
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_TAG.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Listing Tags', 'listdom'); ?></a></span>
        </li>
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_FEATURE.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Listing Features', 'listdom'); ?></a></span>
        </li>
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_LABEL.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Listing Labels', 'listdom'); ?></a></span>
        </li>
        <li>
            <span class="lsd-changelog-added"><a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy='.LSD_Base::TAX_ATTRIBUTE.'&post_type='.LSD_Base::PTYPE_LISTING)); ?>"><?php esc_html_e('Added Attributes', 'listdom'); ?></a></span>
            <ul class="lsd-sub-changelog">
