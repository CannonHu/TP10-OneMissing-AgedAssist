...
<div class="lsd-ix-wrap">
    ...
    <form id="lsd_ix_listdom_import_form" class="lsd-mt-4" enctype="multipart/form-data">
        ...
        <div class="lsd-form-row">
            <div class="lsd-col-12">
                <p id="lsd_ix_listdom_import_message">
                </p>
                <?php echo LSD_Base::alert(esc_html__("You should upload only JSON file exported from Listdom!", 'listdom'), 'info'); ?>
            </div>
        </div>
    </form>
...
jQuery('#lsd_ix_listdom_import_file_input').on('change', function()
{
    ...
    var $alert = jQuery("#lsd_ix_listdom_import_message");
    var $submit = jQuery("#lsd_ix_listdom_import_submit");
...
jQuery('#lsd_ix_listdom_import_form').on('submit', function(e)
{
    ...
    // Button
    var $button = jQuery("#lsd_ix_listdom_import_submit");
    ...
    var data = jQuery("#lsd_ix_listdom_import_form").serialize();
    jQuery.ajax(
    {
        type: "POST",
        url: ajaxurl,
