...
class LSD_Taxonomies_Location extends LSD_Taxonomies
{
    ...
    public function init()
    {
        ...
        add_action(LSD_Base::TAX_LOCATION.'_add_form_fields', array($this, 'add_form'));
        add_action(LSD_Base::TAX_LOCATION.'_edit_form_fields', array($this, 'edit_form'));
        add_action('created_'.LSD_Base::TAX_LOCATION, array($this, 'save_metadata'));
        add_action('edited_'.LSD_Base::TAX_LOCATION, array($this, 'save_metadata'));

        add_filter('manage_edit-'.LSD_Base::TAX_LOCATION.'_columns', array($this, 'filter_columns'));
        add_filter('manage_'.LSD_Base::TAX_LOCATION.'_custom_column', array($this, 'filter_columns_content'), 10, 3);
        add_filter('manage_edit-'.LSD_Base::TAX_LOCATION.'_sortable_columns', array($this, 'filter_sortable_columns'));
    }
    ...
    public function register()
    {
        $args = array(
            ...
            'hierarchical'=>true,
            'has_archive'=>true,
            'rewrite'=>array('slug'=>LSD_Options::location_slug()),
        );
