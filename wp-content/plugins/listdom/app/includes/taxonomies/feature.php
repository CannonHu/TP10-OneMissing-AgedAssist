...
class LSD_Taxonomies_Feature extends LSD_Taxonomies
{
    ...
    public function init()
    {
        ...
        add_action(LSD_Base::TAX_FEATURE.'_add_form_fields', array($this, 'add_form'));
        add_action(LSD_Base::TAX_FEATURE.'_edit_form_fields', array($this, 'edit_form'));
        add_action('created_'.LSD_Base::TAX_FEATURE, array($this, 'save_metadata'));
        add_action('edited_'.LSD_Base::TAX_FEATURE, array($this, 'save_metadata'));

        add_filter('manage_edit-'.LSD_Base::TAX_FEATURE.'_columns', array($this, 'filter_columns'));
        add_filter('manage_'.LSD_Base::TAX_FEATURE.'_custom_column', array($this, 'filter_columns_content'), 10, 3);
        add_filter('manage_edit-'.LSD_Base::TAX_FEATURE.'_sortable_columns', array($this, 'filter_sortable_columns'));
    }
    ...
    public function register()
    {
        $args = array(
            ...
            'rewrite'=>array('slug'=>LSD_Options::feature_slug()),
        );
