...
class LSD_Taxonomies_Label extends LSD_Taxonomies
{
    ...
    public function init()
    {
        ...
        add_action(LSD_Base::TAX_LABEL.'_add_form_fields', array($this, 'add_form'));
        add_action(LSD_Base::TAX_LABEL.'_edit_form_fields', array($this, 'edit_form'));
        add_action('created_'.LSD_Base::TAX_LABEL, array($this, 'save_metadata'));
        add_action('edited_'.LSD_Base::TAX_LABEL, array($this, 'save_metadata'));
    }
    ...
    public function register()
    {
        $args = array(
            ...
            'hierarchical'=>false,
            'has_archive'=>true,
            'rewrite'=>array('slug'=>LSD_Options::label_slug()),
        );
