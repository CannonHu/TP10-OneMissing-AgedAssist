...
if(!class_exists('LSD_Widgets_Search')):
...
class LSD_Widgets_Search extends WP_Widget
{
    ...
    {
        parent::__construct('LSD_Widgets_Search', esc_html__('(Listdom) Search', 'listdom'), array('description'=>esc_html__('A search form to filter listings!', 'listdom')));
