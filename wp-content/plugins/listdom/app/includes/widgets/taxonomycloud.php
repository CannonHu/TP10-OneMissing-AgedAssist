...
class LSD_Widgets_TaxonomyCloud extends WP_Widget
{
    ...
    {
        parent::__construct('LSD_Widgets_TaxonomyCloud', esc_html__('(Listdom) Cloud', 'listdom'), array('description'=>esc_html__('Put tag cloud of Listdom taxonomies into a sidebar/widget area.', 'listdom')));
    ...
    public function widget($args, $instance)
    {
        ...
        echo LSD_Kses::page($shortcode->output($instance));
