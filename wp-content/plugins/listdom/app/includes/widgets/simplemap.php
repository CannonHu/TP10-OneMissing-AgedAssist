...
class LSD_Widgets_SimpleMap extends WP_Widget
{
    ...
    {
        parent::__construct('LSD_Widgets_SimpleMap', esc_html__('(Listdom) Simple Map', 'listdom'), array('description'=>esc_html__('Show a certain address on map.', 'listdom')));
    ...
    public function widget($args, $instance)
    {
        ...
        $zoomlevel = isset($instance['zoomlevel']) ? $instance['zoomlevel'] : 14;
    ...
    public function form($instance)
    {
        ...
        echo '<p class="lsd-widget-row">
            ...
            '.LSD_Form::select(array(
                ...
                'class' => 'widefat',
                'value' => (isset($instance['zoomlevel']) ? $instance['zoomlevel'] : 14),
                'options' => array(
                    5 => 5,
                    6 => 6,
                    7 => 7,
