...
class LSD_Skins_List extends LSD_Skins
{
    ...
    {
        add_action('wp_ajax_lsd_list_load_more', array($this, 'filter'));
        add_action('wp_ajax_nopriv_lsd_list_load_more', array($this, 'filter'));

        add_action('wp_ajax_lsd_list_sort', array($this, 'filter'));
        add_action('wp_ajax_nopriv_lsd_list_sort', array($this, 'filter'));
    }
