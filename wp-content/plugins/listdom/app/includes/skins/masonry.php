...
class LSD_Skins_Masonry extends LSD_Skins
{
    ...
    public function after_start()
    {
        ...
        $this->filter_by = isset($this->skin_options['filter_by']) ? $this->skin_options['filter_by'] : LSD_Base::TAX_CATEGORY;
    }
    ...
    public function filters()
    {
        ...
        $terms = get_terms($this->filter_by, array
        (
            'hide_empty' => true,
    ...
    public function filters_classes($id)
    {
        $output = '';
        $terms = wp_get_post_terms($id, $this->filter_by, array
        (
            'hide_empty' => true,
        ));
    ...
    public function has_listing($term)
    {
        $has = false;
