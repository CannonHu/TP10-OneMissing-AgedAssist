...
if(!class_exists('LSD_Shortcodes')):
...
class LSD_Shortcodes extends LSD_Base
{
    ...
    public function parse($post_id, $atts = array())
    {
        ...
        $skin = (isset($post_atts['lsd_display']) and isset($post_atts['lsd_display']['skin'])) ? $post_atts['lsd_display']['skin'] : $this->get_default_skin();
        foreach($atts as $key=>$value)
        {
            if(isset($post_atts['lsd_display'][$skin]) and isset($post_atts['lsd_display'][$skin][$key]))
            {
