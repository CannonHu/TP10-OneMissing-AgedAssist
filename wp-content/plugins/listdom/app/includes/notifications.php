...
class LSD_Notifications extends LSD_Base
{
    ...
    {
        $placeholders = array(
            'lsd_contact_owner' => array(
                'name' => esc_html__('Name field of contact form', 'listdom'),
                'email' => esc_html__('Email field of contact form', 'listdom'),
                'phone' => esc_html__('Phone field of contact form', 'listdom'),
                'message' => esc_html__('Sent message', 'listdom'),
                'listing_link' => esc_html__('Link to the listing', 'listdom'),
            ),
            'lsd_new_listing' => array(
            ...
            'lsd_listing_status_changed' => array(
            ...
            'lsd_listing_report_abuse' => array(
            ...
            'general' => array(
                ...
                'admin_email' => esc_html__('Email of website Admin', 'listdom'),
                ...
                'site_link' => esc_html__('Link to the website. Subject of website will use as link title', 'listdom'),
            ),
        );
