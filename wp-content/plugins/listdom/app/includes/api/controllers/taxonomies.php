...
class LSD_API_Controllers_Taxonomies extends LSD_API_Controller
{
    ...
    public function terms(WP_REST_Request $request)
    {
        ...
        $taxonomy = isset($vars['taxonomy']) ? $vars['taxonomy'] : LSD_Base::TAX_CATEGORY;
        $hide_empty = isset($vars['hide_empty']) ? $vars['hide_empty'] : false;
        $parent = isset($vars['parent']) ? $vars['parent'] : 0;
        $orderby = isset($vars['orderby']) ? $vars['orderby'] : 'name';
