...
class LSD_API_Validation extends LSD_API
{
    ...
    public function APIToken(WP_REST_Request $request, $token = NULL)
    {
        // Check Token
        if(trim($token))
        {
    ...
    public function UserToken(WP_REST_Request $request, $token = NULL)
    {
        // Check User
        if(trim($token))
        {
    ...
    public function numeric($param, $request, $key)
    {
