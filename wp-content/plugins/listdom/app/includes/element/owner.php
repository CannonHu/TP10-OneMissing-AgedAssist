...
class LSD_Element_Owner extends LSD_Element
{
     ...
     * @param string $layout
	 */
	public function __construct($layout = 'details', $args = array())
    {
        ...
        <div class="lsd-element-options lsd-util-hide" id="lsd_options_'.esc_attr($this->key).'">
            <div class="lsd-form-row">
                ...
                <div class="lsd-col-2">
                    ...
                    '.LSD_Form::switcher(array
                    (
                        'id'=>'lsd_elements_'.esc_attr($this->key).'_display_tel',
                        'name'=>'lsd[elements]['.esc_attr($this->key).'][display_tel]',
                        'options'=>array('1'=>esc_html__('Yes', 'listdom'), '0'=>esc_html__('No', 'listdom')),
                        'value'=>(isset($data['display_tel']) ? $data['display_tel'] : 1),
                    )).'
                </div>
                <div class="lsd-col-2">
                    ...
                    (
                        ...
                        'options'=>array('1'=>esc_html__('Yes', 'listdom'), '0'=>esc_html__('No', 'listdom')),
                        'value'=>(isset($data['display_email']) ? $data['display_email'] : 1),
                    )).'
                </div>
                <div class="lsd-col-2">
                    ...
                    (
                        ...
                        'options'=>array('1'=>esc_html__('Yes', 'listdom'), '0'=>esc_html__('No', 'listdom')),
                        'value'=>(isset($data['display_mobile']) ? $data['display_mobile'] : 1),
                    )).'
                </div>
                <div class="lsd-col-2">
                    ...
                    (
                        ...
                        'options'=>array('1'=>esc_html__('Yes', 'listdom'), '0'=>esc_html__('No', 'listdom')),
                        'value'=>(isset($data['display_website']) ? $data['display_website'] : 0),
                    )).'
                </div>
                <div class="lsd-col-2">
                    ...
                    (
                        ...
                        'options'=>array('1'=>esc_html__('Yes', 'listdom'), '0'=>esc_html__('No', 'listdom')),
                        'value'=>(isset($data['display_fax']) ? $data['display_fax'] : 1),
                    )).'
                </div>
            </div>
            '.$additional.'
