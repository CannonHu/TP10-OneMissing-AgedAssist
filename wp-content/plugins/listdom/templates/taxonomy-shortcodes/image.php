...
// Max Grid
$max_grid = isset($this->atts['max_grid']) ? $this->atts['max_grid'] : 8;
if(!is_numeric($max_grid) or (is_numeric($max_grid) and ($max_grid > 8 or $max_grid < 1))) $max_grid = 8;

// Border Radius
$border_radius = (isset($this->atts['border_radius']) and $this->atts['border_radius']) ? true : false;
...
?>
<div class="lsd-taxonomy-shortcode-wrapper lsd-taxonomy-shortcode-image lsd-font-m <?php echo ($border_radius ? 'lsd-border-radius' : ''); ?>">
